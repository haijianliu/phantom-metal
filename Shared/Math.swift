...
func matrix4x4_rotation(radians: Float, axis: Vector3) -> Matrix4x4 {
...
func matrix4x4_translation(_ translationX: Float, _ translationY: Float, _ translationZ: Float) -> Matrix4x4 {
...
func matrix_perspective_right_hand(fovyRadians fovy: Float, aspectRatio: Float, nearZ: Float, farZ: Float) -> Matrix4x4 {
